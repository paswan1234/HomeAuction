...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'id_referer'); ?>
		<?php echo $form->textField($model,'id_referer'); ?>
		<?php echo $form->error($model,'id_referer'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'concession_amout'); ?>
		<?php echo $form->textField($model,'concession_amout'); ?>
		<?php echo $form->error($model,'concession_amout'); ?>
	</div>
