...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'id_sponser'); ?>
		<?php echo $form->textField($model,'id_sponser'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'id_referer'); ?>
	...
	<div class="row">
		<?php echo $form->label($model,'concession_amout'); ?>
