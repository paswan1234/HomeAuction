...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('ha_id')); ?>:</b>
	<?php echo CHtml::encode($data->ha_id); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('num_units')); ?>:</b>
	<?php echo CHtml::encode($data->num_units); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('mission_statement')); ?>:</b>
	<?php echo CHtml::encode($data->mission_statement); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('zip4')); ?>:</b>
	<?php echo CHtml::encode($data->zip4); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('formatted_address')); ?>:</b>
	<?php echo CHtml::encode($data->formatted_address); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('google_num_results')); ?>:</b>
	<?php echo CHtml::encode($data->google_num_results); ?>
	<br />
