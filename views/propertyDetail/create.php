...
<h1>Add Property Detail</h1>

<?php
echo $this->renderPartial('_form', array('model' => $model, 'amenities' => $amenities,
    'amenitiesU' => $amenitiesU,
    'otheramenities' => $otheramenities,
    'otherunitamenities' => $otherunitamenities, 'id_property' => $id_property,));
?>